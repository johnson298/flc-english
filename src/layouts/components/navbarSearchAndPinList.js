export default {
    ...
    {index: 77, label: 'Editor View', url: '/extensions/access-control-editor', labelIcon: 'EditIcon', highlightAction: false},
    {index: 78, label: 'Admin View', url: '/extensions/access-control-admin', labelIcon: 'AwardIcon', highlightAction: false},
    {index: 79, label: 'I18n', url: '/extensions/i18n', labelIcon: 'GlobeIcon', highlightAction: false},
    {index: 80, label: 'Carousel', url: '/extensions/carousel', labelIcon: 'LayersIcon', highlightAction: false},
		{index: 81, label: 'Clipboard', url: '/extensions/clipboard', labelIcon: 'CopyIcon', highlightAction: false},
		{index: 82, label: 'Context Menu', url: '/extensions/context-menu', labelIcon: 'MoreHorizontalIcon', highlightAction: false},
		{index: 83, label: 'Star Rating', url: '/extensions/star-ratings', labelIcon: 'StarIcon', highlightAction: false},
		{index: 84, label: 'Autocomplete', url: '/extensions/autocomplete', labelIcon: 'Edit3Icon', highlightAction: false},
		{index: 85, label: 'Tree', url: '/extensions/tree', labelIcon: 'GitPullRequestIcon', highlightAction: false},
	]
}
